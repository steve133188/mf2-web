...
export const BroadcastSVG = (props) => {
    return (
        <svg id="cog" xmlns="http://www.w3.org/2000/svg"   width={props.size} height={props.size} fill="currentColor" viewBox="0 0 16.801 16.801">
...
export const ProductsSVG = (props) => {
    return (
        <svg id="store" xmlns="http://www.w3.org/2000/svg"  width={props.size} height={props.size} fill="currentColor" viewBox="0 0 16.8 16.8">
