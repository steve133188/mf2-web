...
export function EnhancedTable2() {
    const [order, setOrder] = React.useState('asc');
    const [orderBy, setOrderBy] = React.useState('role');

    function createData(tag, total, maryFoster, harryStewart,) {
        return {
            tag,
            total,
            maryFoster,
    ...
    const rows = [
        createData(<Pill color="vip" size="longer">VIP</Pill>, 70, 22, 30),
        createData(<Pill color="vvip" size="longer">VVIP</Pill>, 60, 10, 6),
        createData(<Pill color="newCustomer" size="longer">New Customer</Pill>, 55, 20, 30),
        createData(<Pill color="promotions" size="longer">Promotions</Pill>, 58, 10, 6),
    ];
                                ...
                                .map((row) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell sx={{padding: "26px", fontSize: "16px"}} align="left">{row.maryFoster}</TableCell>
                                            <TableCell sx={{padding: "26px", fontSize: "16px"}} align="left">{row.harryStewart}</TableCell>
