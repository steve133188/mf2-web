    ...
    return (
        ...
        <div className={"layout-sidebar "+ (isCollapse ? "collapseLayout" :null)}>
            ...
            <div className={"nav-items"}>
                ...
                <NavItem url={"/livechat"} name={"Live Chat"} icon={(<CommentsAltSVG/>)} active={isActiveURL("/livechat")}/>
                <NavItem url={"/contacts"} name={"Contacts"} icon={(<ContactSVG/>)} active={isActiveURL("/contacts")}/>
                <NavItem url={"/integrations"} name={"Integrations"} icon={(<IntegrationsSVG/>)} active={isActiveURL("/integrations")}/>
                <NavItem url={"/organization"} name={"Organization"} icon={(<OrganizationSVG/>)} active={isActiveURL("/organization")}/>
                <NavItem url={"/admin"} name={"Admin"} icon={(<AdminSVG/>)} active={isActiveURL("/admin")}/>
