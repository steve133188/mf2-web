        ...
        <div className={"layout-sidebar"}>
            ...
            <div className={"nav-items"}>
                <div className={router.pathname.includes("/dashboard") ? "active-side-item" : "side-item "}>
                    ...
                    } onClick={e=>{setIsDashOpen(!isDashOpen)}}>
                    ...
                    {isDashOpen ?(
                        ...
                        <Link href={"/dashboard/livechat"} >
                            <div className={router.pathname.includes("/dashboard/livechat") ? "active_text nav-item sub-nav-item" : "nav-item sub-nav-item"}>Live Chat</div>
                        </Link>
                        <Link href={"/dashboard/agents"} >
                            <div className={router.pathname.includes("/dashboard/agents") ? "active_text nav-item sub-nav-item" : "nav-item sub-nav-item"}>Agents</div>
                        </Link> </>): null}
